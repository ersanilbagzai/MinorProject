 ...
 * @author sachinsir
 */
@WebServlet(name = "cus_ch_pass_serv", urlPatterns = {"/cus_ch_pass_serv"})
public class cus_ch_pass_serv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      ResultSet r=st.executeQuery("select * from regcustomer where email='"+email+"' and password='"+passold+"'");
  if(r.next())
  {
       Statement st1 = con.createStatement();
    st1.execute("update regcustomer set password='"+passnew+"' where email='"+email+"'"); 
