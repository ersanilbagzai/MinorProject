<%-- 
    Document   : cus_accesories
    Created on : Apr 16, 2015, 11:05:09 AM
    Author     : sachinsir
--%>
    ...
    <body>
     ...
     String email =(String)session.getAttribute("uclog");
        ...
        <div id="wrapper">
         ...
         ResultSet rs1= st1.executeQuery("select * from stproducts");
                           while(rs1.next())
       {     %>
                            <div id="products">
                                <div class="product">
                                    <img height="234" width="238" src="css_c/images/cus_acc1.jpg" alt="" />
                                    <div class="pr-info">
                                        <h4>nike</h4>
                                        <p>running shoes </p>
                                        <span class="pr-price"><span>2670/-</span>
                                    </div>
                                </div> <%if(rs1.next()){%>
                                <div class="product"> 
                                    <img height="234" width="238" src="css_c/images/cus_acc2.jpg" alt="" />
                                    <div class="pr-info">
                                        <h4>jewellery  </h4>
                                        <p>AD neck less </p>
                                        <span class="pr-price"><span>999/-</span>
                                    </div>
                                </div> <% } %>
                                <%if(rs1.next()){%>
                                <div class="product last">
                                    <img height="234" width="238" src="css_c/images/cus_acc3.jpg" alt="" />
                                    <div class="pr-info">
                                        <h4>Titan</h4>
                                        <p>couple watch</p>
                                        <span class="pr-price"><span>4500/-</span>
                                    </div>
                                </div> <% } %>
                                <div class="cl">&nbsp;</div>
                            </div><% } %>
