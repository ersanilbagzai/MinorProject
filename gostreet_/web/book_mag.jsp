<%-- 
    Document   : book_mag
    Created on : Apr 10, 2015, 8:46:54 PM
    Author     : sachinsir
--%>
            ...
            <div id="main">
                ...
                <div id="content">
                    ...
                    <div class="products">
                        <div class="cl">&nbsp;</div>
                        <ul>
                            <li> <a href="mp1.jsp"><img  height="383" width="231" src="css/images/b1.jpg" alt="" /></a>
                                <div class="product-info">
                                    <h3>comics</h3>
                                    <div class="product-desc">
                                        <p> <b><h4>CRAYON SHINCHAN</h4></b></p>


                                        <strong class="price">100/- </strong> </div>
                                </div>
                            </li>
                            <li> <a href="mp2.jsp"><img height="383" width="231" src="css/images/b2.jpg" alt="" /></a>
                                <div class="product-info">
                                    <h3>comics</h3>
                                    <div class="product-desc">
                                        <p><b><h4>spiderman</h4></b></p>


                                        <strong class="price">60/-</strong> </div>
                                </div>
                            </li>
                            <li class="last"> <a href="mp3.jsp"><img  height="383" width="231" src="css/images/b3.jpg" alt="" /></a>
                                <div class="product-info">
                                    <h3>NOVEL</h3>
                                    <div class="product-desc">
                                        <p><h4>2 STATES</h4></p>

                                        <strong class="price">70/-</strong> </div>
                                </div>
                            </li>
                        </ul>
                        <div class="cl">&nbsp;</div>
