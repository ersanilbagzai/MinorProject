<%-- 
    ...
    Created on : Apr 10, 2015, 8:46:30 PM
    Author     : sachinsir
--%>
            ...
            <div id="main">
                ...
                <div id="content">
                    ...
                    <div class="products">
                        <div class="cl">&nbsp;</div>
                        <ul>
                            <li> <a href="mp1.jsp"><img height="383" width="231" src="css/images/e1.gif" alt="" /></a>
                                <div class="product-info">
                                    <h3>toshiba</h3>
                                    <div class="product-desc">
                                        <p> <b><h4>LAPTOP</h4></b></p>


                                        <strong class="price">32000/- </strong> </div>
                                </div>
                            </li>
                            <li> <a href="mp2.jsp"><img height="383" width="231" src="css/images/e2.jpg" alt="" /></a>
                                <div class="product-info">
                                    <h3>XBOX 360</h3>
                                    <div class="product-desc">
                                        <p><b><h4>GAMING CONSOLE</h4></b></p>


                                        <strong class="price">28,000/-</strong> </div>
                                </div>
                            </li>
                            <li class="last"> <a href="mp3.jsp"><img height="383" width="231" src="css/images/e3.jpg" alt="" /></a>
                                <div class="product-info">
                                    <h3>LENOVO YOGA</h3>
                                    <div class="product-desc">
                                        <p><h4>LAPTOP</h4></p>

                                        <strong class="price">55000/-</strong> </div>
                                </div>
                            </li>
                        </ul>
                        <div class="cl">&nbsp;</div>
