<%-- 
    Document   : cus_outfit
    Created on : Apr 16, 2015, 11:04:03 AM
    Author     : sachinsir
--%>
    ...
    <body>
     ...
     String email =(String)session.getAttribute("uclog");
       ...
       {     %>
                            <div id="products">
                                <div class="product">
                                    <img height="234" width="238" src="css_c/images/cus_ele1.jpg" alt="" />
                                    <div class="pr-info">
                                        <h4>laptop</h4>
                                        <p>dell ultrabook </p>
                                        <span class="pr-price"><span>52000/-</span>
                                    </div>
                                </div>
                                <%if(rs1.next()){%>
                                <div class="product">
                                    <img height="234" width="238" src="demo/cus_ele1.jpg" alt="" />
                                    <div class="pr-info">
                                        <h4>tablet</h4>
                                        <p>lenovo windows tablet </p>
                                        <span class="pr-price"><span>14999/-</span>
                                    </div>
                                </div><% } %>
                                 <%if(rs1.next()){%>
                                <div class="product last">
                                    <img height="234" width="238" src="css_c/images/cus_ele3.jpg" alt="" />
                                    <div class="pr-info">
                                        <h4>digital camera</h4>
                                        <p>sony cyber shot</p>
                                        <span class="pr-price"><span>11500/-</span>
                                    </div>
                                </div> <% } %>
