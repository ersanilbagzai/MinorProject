<%-- 
    Document   : index
    Created on : Apr 15, 2015, 12:47:42 PM
    Author     : sachinsir
--%>
                ...
                <div class="shell">
                    ...
                    <div id="main">
                        ...
                        <div id="content">
                            ...
                            <div id="products">
                                <div class="product">
                                    <img height="234" width="238" src="css_c/images/product-img1.jpg" alt="" />
                                    <div class="pr-info">
                                        <h4>men's wear</h4>
                                        <p>Leather jacket </p>
                                        <span class="pr-price"><span>1999/-</span>
                                    </div>
                                </div>
                                <div class="product">
                                    <img height="234" width="238" src="css_c/images/product-img2.jpg" alt="" />
                                    <div class="pr-info">
                                        <h4>Home need</h4>
                                        <p>furniture </p>
                                ...
                                <div class="product last">
                                    <img height="234" width="238" src="css_c/images/product-img3.jpg" alt="" />
                                    <div class="pr-info">
                                        <h4>Novel</h4>
                                        <p>fifty shades of grey</p>
                                        <span class="pr-price"><span>99/-</span>
                                    </div>
                                </div>
                                <div class="cl">&nbsp;</div>
                            </div>
