<%-- 
    Document   : home_need
    Created on : Apr 10, 2015, 8:45:33 PM
    Author     : sachinsir
--%>
            ...
            <div id="main">
                ...
                <div id="content">
                    ...
                    <div class="products">
                        <div class="cl">&nbsp;</div>
                        <ul>
                            <li> <a href="mp1.jsp"><img height="383" width="231" src="css/images/h1.jpg" alt="" /></a>
                            ...
                            <li> <a href="mp2.jsp"><img height="383" width="231" src="css/images/h2.jpg" alt="" /></a>
                                <div class="product-info">
                                    <h3>LG G3</h3>
                                    <div class="product-desc">
                                        <p><b><h4>MOBILE</h4></b></p>


                                        <strong class="price">38,000/-</strong> </div>
                                </div>
                            </li>
                            <li class="last"> <a href="mp3.jsp"><img height="383" width="231" src="css/images/h3.jpg" alt="" /></a>
                                <div class="product-info">
                                    <h3>BIBA</h3>
                                    <div class="product-desc">
