<%-- 
    Document   : cus_book_mag
    Created on : Apr 16, 2015, 11:06:22 AM
    Author     : sachinsir
--%>
    ...
    <body>
     ...
     String email =(String)session.getAttribute("uclog");
       ...
       {     %>
                            <div id="products">
                                <div class="product">
                                    <img height="234" width="238" src="css_c/images/cus_bo1.jpg" alt="" />
                                    <div class="pr-info">
                                        <h4>comic</h4>
                                        <p>doremon </p>
                                        <span class="pr-price"><span>90/-</span>
                                    </div>
                                </div> <%if(rs1.next()){%>
                                <div class="product">
                                    <img height="234" width="238" src="css_c/images/cus_bo2.jpg" alt="" />
                                    <div class="pr-info">
                                        <h4>novel</h4>
                                        <p>revolution 2020 </p>
                                        <span class="pr-price"><span>120/-</span>
                                    </div>
                                ...
                                <div class="product last">
                                    <img height="234" width="238" src="css_c/images/cus_bo3.jpg" alt="" />
                                    <div class="pr-info">
                                        <h4>biography</h4>
                                        <p>wings of fire</p>
                                        <span class="pr-price"><span>150/-</span>
                                    </div>
                                </div><% } %>
                                <div class="cl">&nbsp;</div>
                            </div><% } %>
