<%-- 
    Document   : us_g_cus_login
    Created on : Apr 15, 2015, 10:35:40 PM
    Author     : sachinsir
--%>
        ...
        <div class="shell">
            ...
            <div id="main">
                ...
                <div id="content">
                    ...
                    <!-- End Content Slider -->
                    <!-- Products -->
                     <div style="height:115px; width:300px; margin: 0 auto; margin-top: 150px; border:solid 2px black; border-color: black; "> 
                    <form style="" action="http://localhost:8084/gostreet_/cust_log_serv" method="post">
