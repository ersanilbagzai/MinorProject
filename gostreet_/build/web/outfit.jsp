<%-- 
    Document   : outfit
    Created on : Apr 10, 2015, 8:45:11 PM
    Author     : sachinsir
--%>
            ...
            <div id="main">
                ...
                <div id="content">
                    ...
                    <div class="products">
                        <div class="cl">&nbsp;</div>
                        <ul>
                            <li> <a href="mp1.jsp"><img height="383" width="231" src="css/images/mp1.jpg" alt="" /></a>
                                <div class="product-info">
                                    <h3>Woodland</h3>
                                    <div class="product-desc">
                                        <p> <b><h4>MEN’S WEAR</h4></b></p>


                                        <strong class="price">4000/- </strong> </div>
                                </div>
                            </li>
                            <li> <a href="mp2.jsp"><img height="383" width="231" src="css/images/o2.jpg" alt="" /></a>
                                <div class="product-info">
                                    <h3>SUIT</h3>
                                    <div class="product-desc">
                                        <p><b><h4>MODERN NET</h4></b></p>


                                        <strong class="price">3999/-</strong> </div>
                                </div>
                            </li>
                            <li class="last"> <a href="mp3.jsp"><img height="383" width="231" src="css/images/mp3.jpg" alt="" /></a>
                                <div class="product-info">
                                    <h3>BIBA</h3>
                                    <div class="product-desc">
                                        <p><h4>WOMEN’S WEAR</h4></p>

                                        <strong class="price">700/-</strong> </div>
                                </div>
                            </li>
                        </ul>
                        <div class="cl">&nbsp;</div>
