        ...
        <div class="shell">
            ...
            <div id="main">
                ...
                <div id="content">
                    ...
                    <form action="http://localhost:8080/gostreet_/reg_cus" method="post">
                        <div  style="margin-top: 30px; height: 400px; width: 400px; margin: 0 auto; border:solid 2px black; border-color: black; "> <form action="http://localhost:8080/amitweb/regserv" method="post">
                                ...
                                <table cellspacing="15px" style="margin:0 auto; margin-top: 30px; " >
                                    <tr>
                                        ...
                                        <td> <input type="text" name="txtnamec"></input></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Enter Email:
                                        </td>
                                        <td> <input type="text" name="txtemailc"></input></td> 
                                    </tr>
                                     <tr>
                                        <td>
                                            Enter City:
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td><input type="text" name="txtpinc"> </input> </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="password" name="txtpassc"> </input> </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Retype Password:
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="txtpnoc"> <td> 
                                    </tr> 
                                    <tr>
                                        <td>
                                            Enter Address:
                                        ...
                                        <td>
                                            <textarea name="txtaddrc"></textarea>
                                        </td>
