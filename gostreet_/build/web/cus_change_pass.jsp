<%-- 
    Document   : cus_change_pass
    Created on : Apr 16, 2015, 11:07:38 AM
    Author     : sachinsir
--%>
                ...
                <div class="shell">
                    ...
                    <div id="main">
                        ...
                        <div id="content">
                            ...
                            <form action="http://localhost:8080/gostreet_/cus_ch_pass_serv" method="post">
      <div  style="margin-top: 90px; height: 250px; width: 400px; margin: 0 auto; border:solid 2px black; border-color: black; "> 
