<%-- 
    Document   : cus_sh_mu_profile
    Created on : Apr 16, 2015, 11:07:03 AM
    Author     : sachinsir
--%>
        ...
        <div id="wrapper">
            ...
            <div class="inner">
                ...
                <div class="shell">
                    ...
                    <div  style="margin-top: 50px; height: 350px; width: 400px; margin: 0 auto; border:solid 2px black; border-color: black; ">
